    ...
    return (
        <React.Fragment>
            ...
            <main className="container top-5">
                <div className="d-flex ms-auto me-auto w-profile p-2 m-2">
                    <img src={user} alt="user icon" className="user_icon img-fluid"/>
                    <div className="card-body">
                        <h1 className="card-title">Фамилия Имя</h1>
                        <p className="card-subtitle">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci animi error excepturi id
                            ipsum reprehenderit ut voluptatum. Deleniti fugit ipsam, itaque quas, quo, quod
                            reprehenderit sed suscipit ullam vitae voluptas.
                        </p>
                    </div>
                </div>
